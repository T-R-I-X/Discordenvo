class Queuing {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (object.afterEvent) {
        if (!object.afterEvent.emitter || !object.afterEvent.event)
          return reject(
            "addToQueue Error: Missing emitter or event options in afterEvent"
          );
      }
      if (typeof object.value == "function") {
        ...
        if (!Array.isArray(object.args))
          return reject(
            "addToQueue Error: Argument option needs to be an array"
          );
        funcType = true;
      }
  ...
  unQueue(ind = 0) {
    return new Promise((resolve, reject) => {
      if (!this.queue[ind])
        return reject("unQueue Error: Nothing found with this index");
